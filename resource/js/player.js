...
function start() {
  ...
  $('.color-element div li a').click(function() {
    ...
    if ($(this).attr('data-index') == 'bg') {
      ...
      $('.css-label.ui-btn.ui-corner-all.ui-btn-inherit.ui-radio-off').css(
        'background-color',
        color,
      );
  ...
  $('.give').on('click', function() {
    ...
    $('#toadd').val('0');
    $('.radGroup1.css-label.ui-btn.ui-corner-all.ui-btn-inherit').css(
      'background-color',
      bc,
    );
    $(this)
  ...
  $('.take').on('click', function() {
    ...
    $('.radGroup2.css-label.ui-btn.ui-corner-all.ui-btn-inherit').css(
      'background-color',
      bc,
    );
    $(this)
  ...
  $('.adding').bind(event, function() {
    if (add != null && sub != null) {
      ...
      alert('Please select a Donor and a Receiver. ');
    }
  });
  ...
  $('#clearall').click(function() {
    ...
    if (ok == true) {
      ...
      $('.css-label.ui-btn.ui-corner-all.ui-btn-inherit').css(
        'background-color',
        bc,
      );
...
//         'Battery is charging...Battery status: ' + battery.level * 100 + ' %';
//       alert('Battery is charging...');
//     } else {
//       document.getElementById('deviceProperties').innerHTML =
//         'Battery is discharging...Battery status: ' +
//         battery.level * 100 +
//         ' %';
//     }
//   }
  ...
  $('.ui-input-text.ui-body-inherit.ui-corner-all.ui-shadow-inset').removeAttr(
    'class',
  );
}
